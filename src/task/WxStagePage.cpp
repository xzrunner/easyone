...
const std::string WxStagePage::PAGE_TYPE = "task_stage";
...
void WxStagePage::OnPageInit()
{
    ...
    auto prev_canvas = std::static_pointer_cast<tasklab::WxPreviewCanvas>(GetImpl().GetCanvas());
...
WxStagePage::CreateGraphPanel(wxWindow* parent) const
{
    ...
    auto& nodes = tasklab::TaskLab::Instance()->GetAllNodes();
