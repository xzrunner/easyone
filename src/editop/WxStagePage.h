...
#include <editoplab/PreviewPage.h>

#include <editopgraph/ParamType.h>

namespace ee0 { class RenderContext; }
namespace editoplab { class WxEditorPanel; class WxToolbarPanel; }
...
public:
    ...
    virtual int GetPageType() const override { return PAGE_EDITOP; }
...
private:
    editoplab::PreviewPage m_preview_impl;

    editoplab::WxEditorPanel*  m_editor_panel  = nullptr;
    editoplab::WxToolbarPanel* m_toolbar_panel = nullptr;
