...
const std::string WxStagePage::PAGE_TYPE = "editor_stage";
...
void WxStagePage::OnPageInit()
{
    ...
    auto prev_canvas = std::static_pointer_cast<editoplab::WxPreviewCanvas>(GetImpl().GetCanvas());
...
bp::WxGraphPage<editopgraph::ParamType>*
WxStagePage::CreateGraphPanel(wxWindow* parent) const
{
    auto panel = new bp::WxGraphPage<editopgraph::ParamType>(
        parent, m_graph_obj, m_sub_mgr, editoplab::MSG_ROAD_CHANGED, "editopgraph", "editoplab"
    );
    ...
    auto& nodes = editoplab::EditOpLab::Instance()->GetAllNodes();
