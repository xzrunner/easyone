...
#include <visiongraphv/WxToolbarPanel.h>
...
void WxStagePage::OnPageInit()
{
    ...
    auto toolbar_page = new vgv::WxToolbarPanel(toolbar_panel, m_graph_page->GetSubjectMgr());
    toolbar_panel->AddPagePanel(toolbar_page, wxVERTICAL);

    auto prev_canvas = std::static_pointer_cast<vgv::WxPreviewCanvas>(GetImpl().GetCanvas());
...
{
    auto panel = new vgv::WxGraphPage(parent, m_graph_obj, m_sub_mgr);
    ...
    auto& nodes = vgv::VisionGraphView::Instance()->GetAllNodes();
