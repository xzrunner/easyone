...
#include <visiongraphv/PreviewPage.h>

namespace vgv { class WxEditorPanel; class WxToolbarPanel; class WxGraphPage; }
...
public:
    ...
    virtual int GetPageType() const override { return PAGE_VISION_LAB; }
...
private:
    vgv::WxGraphPage* CreateGraphPanel(wxWindow* parent) const;
...
private:
    vgv::PreviewPage m_preview_impl;

    vgv::WxEditorPanel*  m_editor_panel  = nullptr;
    vgv::WxToolbarPanel* m_toolbar_panel = nullptr;

    n0::SceneNodePtr m_graph_obj = nullptr;
    vgv::WxGraphPage* m_graph_page = nullptr;
