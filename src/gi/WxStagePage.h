...
#include <gilab/PreviewPage.h>

namespace gilab { class WxGraphPage; }
...
public:
	...
	virtual int GetPageType() const override { return PAGE_GI_GRAPH; }
...
private:
    gilab::WxGraphPage* CreateGraphPanel(wxWindow* parent) const;
...
private:
    ...
    gilab::PreviewPage m_preview_impl;
